...
func (c *greetServiceClient) SayHelloClientStreaming(ctx context.Context, opts ...grpc.CallOption) (GreetService_SayHelloClientStreamingClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[0], GreetService_SayHelloClientStreaming_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *greetServiceClient) SayHelloServerStreaming(ctx context.Context, in *NameList, opts ...grpc.CallOption) (GreetService_SayHelloServerStreamingClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[1], GreetService_SayHelloServerStreaming_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (x *greetServiceSayHelloServerStreamingClient) Recv() (*HelloRequest, error) {
	m := new(HelloRequest)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *greetServiceSayHelloServerStreamingServer) Send(m *HelloRequest) error {
	return x.ServerStream.SendMsg(m)
}
